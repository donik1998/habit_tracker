...
import 'package:habit_tracker/data/remote/firebase_data_service.dart' as _i636;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i636.FirebaseDataService>(
        () => _i636.FirebaseDataService());
    ...
    gh.lazySingleton<_i315.RemoteDataStorage>(() => _i315.RemoteDataStorage());
    return this;
  }
}
